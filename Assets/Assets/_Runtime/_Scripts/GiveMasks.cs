   ...
   public TextMeshProUGUI scoreBoard;
    ...
    void PickupInfected()
    {
        ...
        else
        {
            ...
            victim.GetComponent<CharacterController>().Move((new Vector3(returnPoint.position.x, returnPoint.position.y, returnPoint.position.z) - this.transform.position)*3);
